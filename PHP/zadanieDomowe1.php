...
/////////////// sprawdza po 4 cyfrach numeru konta(od 3 do 6) w jakim banku jest konto.
...
function JakiBank($numerKonta)
{
	...
	foreach ($banki as $klucz => $element) 
	{
		...
		{
			return $wynik =  "Konto o numerze  $numerKonta znajduje sie w $element ";
		}
	}

	if ($klucz != $cyfryWskazujace)
	{
		return $wynik = "Nie ma takiego Banku w Polsce.";
	}
}

echo JakiBank('1211110800901020111110000000456365356465');

//******************************************************************************

// sprawdza czy wyraz jest palindromen(czytany od konca brzmi tak samo)
...
// sprawdza czy dwa wyrazy sa anagramami (skladaja sie z tych samych liter) ??/ czy dobrze??
