...
function drukujCoXznak($slowo, $oIle)
{
...
echo drukujCoXznak('cokolwiek lub cokolwiek innego', 3);
...
{
	$jednosci = array('zero' , 'jeden', 'dwa', 'trzy', 'cztery', 'piec', 'szesc', 'siedem', 'osiem', 'dziewiec');
